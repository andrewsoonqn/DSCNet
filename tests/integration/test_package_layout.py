...
class PackageLayoutTests(unittest.TestCase):
    ...
    def test_flat_package_and_mirrored_tests_are_present(self):
        ...
        mirrored_modules = {
            ...
            "evaluation/inference.py": "evaluation/test_inference.py",
            ...
            "experiment/model_audit.py": "experiment/test_model_audit.py",
            "experiment/model_definition.py": "experiment/test_modeling.py",
            "experiment/modeling.py": "experiment/test_modeling.py",
            ...
            "models/factory.py": "models/test_factory.py",
